  ...
  function decorate() {
    grid.querySelectorAll('.project-card').forEach(card => {
      ...
      const open = app?.published
        ? '<a class="action-button" data-littleapp-open target="_blank" rel="noreferrer" href="littleapp-v3.html?v=20260919-5&app=' + encodeURIComponent(app.slug) + '">' + text('▶ Abrir app', '▶ Open app') + '</a>'
        : '';
      const remove = app
        ...
        : '';
      box.innerHTML = '<a class="button" data-littleapp-builder href="app-builder.html?v=20260919-5&api=' + encodeURIComponent(api.api_id) + '">' + builderLabel + '</a>' + open + remove;
