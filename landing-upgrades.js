(() => {
  ...
  const copy = {
    es: {
      ...
      appsLead:'Crea una aplicación web adaptable desde cualquier API de Google Sheets publicada en LittleAPI. Cinco pasos, vista previa en vivo y una sola plantilla que funciona en escritorio, tablet y móvil.',
    ...
    en: {
      ...
      appsLead:'Create a responsive web app from any Google Sheets API published with LittleAPI. Five steps, live preview, and one shared template that works on desktop, tablet, and mobile.',
