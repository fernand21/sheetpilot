(() => {
  ...
  const copy = {
    es: {
      ...
      appsLead:'Crea una aplicación web adaptable desde cualquier API de Google Sheets. Añade páginas de Datos, Formulario, Panel o Chat, activa acciones CRUD con iconos SVG y personaliza textos en inglés y español.',
    ...
    en: {
      ...
      appsLead:'Create a responsive web app from any Google Sheets API. Add Data, Form, Dashboard or Chat pages, enable SVG CRUD actions, and customize English and Spanish control text.',
