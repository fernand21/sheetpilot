(() => {
  ...
  const copy = {
    es: {
      ...
      appsSteps:['Datos','Pantallas','Campos','Diseño','Publicar'],
    ...
    en: {
      ...
      appsSteps:['Data','Pages','Fields','Design','Publish'],
